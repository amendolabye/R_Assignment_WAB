...
Takes mean value of homozygosity at each position, equal to the fraction of homozygous SNPs at each position, for each position on each chromosome across both groups
...
Graphs average homozygosity value at each position, across each chromosome, for both maize and teosinte
